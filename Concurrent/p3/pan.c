...
short src_ln0 [] = {
	  0,  26,  27,  28,  30,  31,  34,  34, 
	 33,  36,  32,  39,  39,  38,  41,  37, 
	 45,  46,  47,  48,  49,  50,  51,  54, 
	  0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "dphil_starve.pml", 1, 23 },
	{ "-", 24, 25 }
};
uchar reached0 [] = {
	  0,   0,   0,   0,   0,   0,   1,   0, 
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		...
		logval("fed", now.fed);
		logval("start_think", now.start_think);
#endif
}
